...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// Nested functions have access to variables declared in the parent function. Functions OUTSIDE of myFunction() do not have access to the internal variable. 
...
function USApop(arr) {
  const reducer = (total, animal) => total + animal.population;
